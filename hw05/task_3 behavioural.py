# Implementation of Memento as a Behavioural pattern
...
class DumbNeuralNetwork():
    ...
    def restore_weights(self, memento):
        # <YOUR CODE HERE>
        """
        Restore weights saved previously.
        """
        self.weights = memento.get_saved()
...
if __name__ == "__main__":
    ...
    for epoch in range(epoch_number):
        saved_weights.append(dumb_NN.save_weights())
        dumb_NN.train()
        ...
        if loss < best_loss:
            ...
            dumb_NN.restore_weights(saved_weights.pop())
